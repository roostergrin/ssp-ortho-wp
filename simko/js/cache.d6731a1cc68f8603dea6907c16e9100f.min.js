...
if($('.service.for-ages.third .container:inview300').length>0){$('.service.for-ages.third .container aside .img-container img').addClass('active')}else{$('.service.for-ages.third .container aside .img-container img.active').removeClass('active')}})})(jQuery);(function($){let carousel='section.overlap.carousel',device=$(window).width()>782?'desktop':'mobile',owl=$(carousel).find('.owl-carousel'),interval_desktop=null;function resetInterval(){if(interval_desktop)clearInterval(interval_desktop);interval_desktop=setInterval(function(){$(carousel).find('.pagination-container .pagination .page-right').trigger('click')},4000)}
