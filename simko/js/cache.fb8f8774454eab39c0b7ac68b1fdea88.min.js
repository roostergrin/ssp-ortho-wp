...
setInterval(function(){if($.jMaskGlobals.watchDataMask){$.applyDataMask()}},globals.watchInterval)}));(function($){var invisalign_owl=$('.invisalign-carousel .owl-carousel');invisalign_owl.owlCarousel({items:3,slideBy:1,nav:!1,dots:!1,loop:!1,autoWidth:!0,mouseDrag:!0,pullDrag:!0,freeDrag:!1,responsiveClass:!0,responsive:{0:{items:1,loop:!0,margin:40,autoplay:!1,autoplayHoverPause:!0},950:{margin:40,nav:!1,mouseDrag:!1,navigation:!1,}}});invisalign_owl.on('changed.owl.carousel',function(e){invisalign_owl.trigger('stop.owl.autoplay');invisalign_owl.trigger('play.owl.autoplay')});$('section.invisalign-carousel .pagination .page-left').click(function(){invisalign_owl.trigger('prev.owl.carousel')});$('section.invisalign-carousel .pagination .page-right').click(function(){invisalign_owl.trigger('next.owl.carousel')})})(jQuery);(function($){$(window).on('scroll load resize',function(){if($('section.invisalign-carousel:inview').length>0){$.each($('section.invisalign-carousel .column'),function(k,e){setTimeout(function(){$(e).addClass('active');$(e).css('opacity','1')},1000)})}
else{$.each($('section.invisalign-carousel .column'),function(k,e){$(e).removeClass('active');$(e).css('opacity','0')})}})})(jQuery);(function($){let carousel='section.testimonials.carousel',log=!1,time=0,init=!0,paused=!1,autoplay=!0,autoplaying=!1,autoplay_speed=7000,autoplay_interval=!1;function update_height(){$(carousel).find('.content-carousel').css('height',$(carousel).find('.content-carousel .carousel-item.active > .content').outerHeight())}
