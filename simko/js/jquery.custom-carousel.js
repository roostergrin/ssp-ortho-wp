(function($) {
	...
	if ($(carousel).length) {
		...
		$(carousel).find('.mobile-pagination-container .mobile-pagination .icon-right-arrow-thick').on('click', function() {
	...
	$(carousel).find('.mobile-pagination .icon-left-arrow-thick, .page-left').click(function() {
		$(owl).trigger('prev.owl.carousel');
	});

	$(carousel).find('.mobile-pagination .icon-right-arrow-thick, .page-right').click(function() {
