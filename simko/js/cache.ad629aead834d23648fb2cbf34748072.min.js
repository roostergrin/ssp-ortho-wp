...
cookie.delete(key);return!0}})(jQuery);(function($){var $logo_owl_carousel=$('.logo.owl-carousel');var carouselOptions={loop:!0,margin:10,mouseDrag:!0,touchDrag:!0,autoplay:!1,autoplayHoverPause:!0};if($logo_owl_carousel.length){if($logo_owl_carousel.hasClass('disable-desktop')){carouselOptions.responsive={0:{items:1,},768:{items:3,}}}else{carouselOptions.responsive={0:{items:1,},768:{items:5,}}}
$logo_owl_carousel.owlCarousel(carouselOptions);$logo_owl_carousel.on('resize.owl.carousel',function(e){var disableDesktop=$(e.currentTarget).hasClass('disable-desktop');if(innerWidth>768&&disableDesktop){$logo_owl_carousel.trigger('stop.owl.autoplay')}else{$logo_owl_carousel.trigger('play.owl.autoplay')}})
$logo_owl_carousel.on('changed.owl.carousel',function(e){var disableDesktop=$(e.currentTarget).hasClass('disable-desktop');$logo_owl_carousel.trigger('stop.owl.autoplay');if(innerWidth<768&&disableDesktop){$logo_owl_carousel.trigger('play.owl.autoplay')}});$('section.logo-carousel .pagination .icon-page-left').on('click',function(){$logo_owl_carousel.trigger('prev.owl.carousel')});$('section.logo-carousel .pagination .icon-page-right').on('click',function(){$logo_owl_carousel.trigger('next.owl.carousel')})}
var univ_logos=[];if($('.univ-logos.owl-carousel').length){$('.univ-logos.owl-carousel').each(function(k,v){univ_logos.push($(this).owlCarousel({margin:0,loop:!1,dots:!1,responsiveClass:!1,responsive:{0:{items:1,slideBy:1,mouseDrag:!0,touchDrag:!0,loop:!0,nav:!0,navText:[],autoplay:!1,autoplayHoverPause:!0},950:{items:3,slideBy:1,mouseDrag:!1,touchDrag:!1,loop:$(this).find('.logo-container').length>3,navText:[],nav:$(this).find('.logo-container').length>3,autoplayHoverPause:!0}}}))})}})(jQuery);'use strict';(function(factory){if(typeof define==='function'&&define.amd){define(['jquery'],factory)}else if(typeof exports==='object'){module.exports=factory(require('jquery'))}else{factory(jQuery||Zepto)}}(function($){var Mask=function(el,mask,options){var p={invalid:[],getCaret:function(){try{var sel,pos=0,ctrl=el.get(0),dSel=document.selection,cSelStart=ctrl.selectionStart;if(dSel&&navigator.appVersion.indexOf('MSIE 10')===-1){sel=dSel.createRange();sel.moveStart('character',-p.val().length);pos=sel.text.length}
...
setInterval(function(){if($.jMaskGlobals.watchDataMask){$.applyDataMask()}},globals.watchInterval)}));(function($){let carousel='section.overlap.carousel',device=$(window).width()>782?'desktop':'mobile',owl=$(carousel).find('.owl-carousel'),interval_desktop=null;function resetInterval(){if(interval_desktop)clearInterval(interval_desktop);interval_desktop=setInterval(function(){$(carousel).find('.pagination-container .pagination .page-right').trigger('click')},4000)}
