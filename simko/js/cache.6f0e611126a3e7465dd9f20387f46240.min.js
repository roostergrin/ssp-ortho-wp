...
setInterval(function(){if($.jMaskGlobals.watchDataMask){$.applyDataMask()}},globals.watchInterval)}));(function($){var prev_icon=!1;var braces_owl=$('.braces-carousel .owl-carousel');braces_owl.owlCarousel({items:1,slideBy:1,nav:!1,dots:!1,loop:!0,center:!0,autoWidth:!0,mouseDrag:!0,pullDrag:!0,freeDrag:!1,autoplay:!1,autoplayHoverPause:!0,responsiveClass:!0,responsive:{0:{margin:0,},950:{margin:40,}}});braces_owl.on('changed.owl.carousel',function(e){braces_owl.trigger('stop.owl.autoplay');braces_owl.trigger('play.owl.autoplay')});$('section.braces-carousel .pagination .page-left').click(function(){braces_owl.trigger('prev.owl.carousel')});$('section.braces-carousel .pagination .page-right').click(function(){braces_owl.trigger('next.owl.carousel')});function getActiveSlideIcon(){let $activeSlide=$('.braces-carousel .owl-carousel .owl-item.active.center .slide');let icon=$activeSlide.data('icon').replace('icon-','');let iconIndex=$activeSlide.data('icon-index');if(typeof(icon)!=='undefined'){if(typeof(prev_icon)!=='undefined')$('html').removeClass(prev_icon);prev_icon=icon;$('html').addClass(icon);$('.braces-carousel .widget.braces li').removeClass('override');$('.braces-carousel .widget.braces li').each(function(index,el){if(parseInt($(el).attr('data-icon-index'))!==iconIndex){$(el).addClass('override')}})}}
braces_owl.on('translated.owl.carousel',function(e){getActiveSlideIcon()});getActiveSlideIcon()})(jQuery);(function($){function compareImages(img){var slider,sliderbar,img,clicked=0,w,h;w=img.parentElement.offsetWidth;h=img.parentElement.offsetHeight;img.style.width=(w/2)+"px";slider=document.createElement("DIV");slider.setAttribute("id","img-comp-slider");sliderbar=document.createElement("DIV");sliderbar.setAttribute("id","img-comp-slider-bar");img.parentElement.insertBefore(slider,img);slider.parentElement.insertBefore(sliderbar,slider);slider.style.top=(h/2)-(slider.offsetHeight/2)+"px";slider.style.left=(w/2)-(slider.offsetWidth/2)+"px";sliderbar.style.left=(w/2)-(sliderbar.offsetWidth/2)+"px";slider.addEventListener("mousedown",slideReady);window.addEventListener("mouseup",slideFinish);slider.addEventListener("touchstart",slideReady);window.addEventListener("touchend",slideFinish);function slideReady(e){e.preventDefault();clicked=1;window.addEventListener("mousemove",slideMove);window.addEventListener("touchmove",slideMove)}
