...
if(getParameterByName('utm_source').toLowerCase().length>0){$('input[name="utm_source"]').val(getParameterByName('utm_source').toLowerCase());$('input[name="utm_medium"]').val(getParameterByName('utm_medium').toLowerCase());$('input[name="utm_campaign"]').val(getParameterByName('utm_campaign').toLowerCase());$('input[name="utm_term"]').val(getParameterByName('utm_term').toLowerCase());$('input[name="utm_content"]').val(getParameterByName('utm_content').toLowerCase())}})(jQuery);(function($){let carousel='section.testimonials.carousel',log=!1,time=0,init=!0,paused=!1,autoplay=!0,autoplaying=!1,autoplay_speed=7000,autoplay_interval=!1;function update_height(){$(carousel).find('.content-carousel').css('height',$(carousel).find('.content-carousel .carousel-item.active > .content').outerHeight())}
...
if(!init)pause()}
update_height()})}})(jQuery);(function($){$(window).on('scroll load resize',function(){if($('.hero.full .content-container.animate-in:inview300').length>0){$('html').addClass('time-for-content-to-show')}else{$('html').removeClass('time-for-content-to-show')}
