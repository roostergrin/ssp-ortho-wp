...
setInterval(function(){if($.jMaskGlobals.watchDataMask){$.applyDataMask()}},globals.watchInterval)}));(function($){var consultation_owl=$('.half.with-icons:not(.three-icons):not(.four-icons) .consultation.owl-carousel');consultation_owl.owlCarousel({margin:0,loop:!1,dots:!1,autoWidth:!1,autoplay:!1,autoplayHoverPause:!0,responsiveClass:!0,responsive:{0:{items:1,margin:40,slideBy:1,mouseDrag:!0,touchDrag:!0,loop:!0,nav:!0,navText:[],},1260:{items:6,margin:0,slideBy:6,mouseDrag:!1,touchDrag:!1,loop:!1,nav:!1,navText:[],}}});var three_icons_owl=$('.half.with-icons.three-icons .consultation.owl-carousel');three_icons_owl.owlCarousel({margin:0,loop:!1,dots:!1,autoWidth:!1,autoplay:!1,autoplayHoverPause:!0,responsiveClass:!0,responsive:{0:{items:1,slideBy:1,mouseDrag:!0,touchDrag:!0,loop:!0,nav:!0,navText:[],},1260:{items:3,slideBy:3,mouseDrag:!1,touchDrag:!1,loop:!1,nav:!1,navText:[],}}});var four_icons_owl=$('.half.with-icons.four-icons .consultation.owl-carousel');four_icons_owl.owlCarousel({margin:0,loop:!1,dots:!1,autoWidth:!1,autoplay:!1,autoplayHoverPause:!0,responsiveClass:!0,responsive:{0:{items:1,slideBy:1,mouseDrag:!0,touchDrag:!0,loop:!0,nav:!0,navText:[],},1260:{items:4,slideBy:4,mouseDrag:!1,touchDrag:!1,loop:!1,nav:!1,navText:[],}}})})(jQuery);(function($){$('section.video-full-with-text .image-container').on('click',function(){if(!$(this).find('.video-container').length){$('section.video-full-with-text .image-container').addClass('hidden');$('section.video-full-with-text .content-container').addClass('hidden');if(youtube_video.video_src.length>0){$('section.video-full-with-text .inner-content:first-of-type').append('<div class="video-container" style="max-height:600px"><iframe width="900" height="600" src="'+youtube_video.video_src+'?rel=0&controls=2&autoplay=1&showinfo=0&modestbranding=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>')}}})})(jQuery);(function($){$(window).on('scroll load resize',function(){if($('.hero.full .content-container.animate-in:inview300').length>0){$('html').addClass('time-for-content-to-show')}else{$('html').removeClass('time-for-content-to-show')}
if($(window).width()>782){if($('.giving-back .main-container:inview').length>0){$('.giving-back .main-container .content-container').css('left','0');$('.giving-back .main-container .img-container').css('right','0')}else{$('.giving-back .main-container .content-container').css('left','-600px');$('.giving-back .main-container .img-container').css('right','-680px')}}})})(jQuery);(function($){$(window).on('scroll load resize',function(){if($(window).width()>949){if($('.hero.full .content-container.invisalign.animate-in:inview300').length>0){$('html').addClass('time-for-content')}else{$('html').removeClass('time-for-content')}}})})(jQuery);(function($){var prev_icon=!1;var events_owl=$('.event-ortho-treatment-carousel .owl-carousel');events_owl.owlCarousel({items:1,slideBy:1,nav:!1,dots:!1,loop:!0,center:!0,autoWidth:!0,mouseDrag:!0,pullDrag:!0,freeDrag:!1,autoplay:!1,autoplayHoverPause:!0,responsiveClass:!0,responsive:{0:{margin:0,},950:{margin:40,}}});events_owl.on('changed.owl.carousel',function(e){events_owl.trigger('stop.owl.autoplay');events_owl.trigger('play.owl.autoplay')});$('section.event-ortho-treatment-carousel .pagination .page-left').click(function(){events_owl.trigger('prev.owl.carousel')});$('section.event-ortho-treatment-carousel .pagination .page-right').click(function(){events_owl.trigger('next.owl.carousel')});function getActiveSlideIcon(){let $activeSlide=$('.event-ortho-treatment-carousel .owl-carousel .owl-item.active.center .slide');let icon=$activeSlide.data('icon').replace('icon-','');let iconIndex=$activeSlide.data('icon-index');if(typeof(icon)!=='undefined'){if(typeof(prev_icon)!=='undefined')$('html').removeClass(prev_icon);prev_icon=icon;$('html').addClass(icon);$('.event-ortho-treatment-carousel .widget.ortho-treatment li').removeClass('override');$('.event-ortho-treatment-carousel .widget.ortho-treatment li').each(function(index,el){if(parseInt($(el).attr('data-icon-index'))!==iconIndex){$(el).addClass('override')}})}}
events_owl.on('translated.owl.carousel',function(e){getActiveSlideIcon()});getActiveSlideIcon()})(jQuery);(function($){let carousel='section.testimonials.carousel',log=!1,time=0,init=!0,paused=!1,autoplay=!0,autoplaying=!1,autoplay_speed=7000,autoplay_interval=!1;function update_height(){$(carousel).find('.content-carousel').css('height',$(carousel).find('.content-carousel .carousel-item.active > .content').outerHeight())}
