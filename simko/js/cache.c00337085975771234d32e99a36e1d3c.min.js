...
else{$.each($('section.invisalign-carousel .column'),function(k,e){$(e).removeClass('active');$(e).css('opacity','0')})}})})(jQuery);(function($){$(window).on('scroll load resize',function(){if($('.hero.full .content-container.animate-in:inview300').length>0){$('html').addClass('time-for-content-to-show')}else{$('html').removeClass('time-for-content-to-show')}
