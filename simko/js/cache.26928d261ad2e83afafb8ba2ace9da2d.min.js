...
var mapPhoneLink=!noPhoneLinks.includes(map_data.name)?'<p><a href="tel:+1'+map_data.phone_number+'" class="white">'+map_data.phone_number.format_phone('dot')+'</a></p>':"";var info_window=new InfoBox({content:'<div class="info-window"><div class="slide"><p>'+map_data.name+'</p>'+mapPhoneLink+'<p><a href="'+map_data.directions+'" class="cta text white" target="_blank">Directions</a></p><a class="close-info-box" href="javascript:close_info_box()"><i class="icon-close"></i></a></div></div>',disableAutoPan:!0,maxWidth:400,pixelOffset:new google.maps.Size(-0.5*92,-0.5*92),closeBoxURL:'',isHidden:!1,pane:'floatPane',enableEventPropagation:!0,zIndex:4,});var marker=new RichMarker({map:map_object,position:coordinates,draggable:!1,flat:!0,anchor:RichMarkerPosition.MIDDLE,content:'<div class="location-marker"><div class="circle"><div class="center-mark"></div></div></div>',visible:!0,scaledSize:new google.maps.Size(92,92),});info_window.marker=marker;(function(marker,info,map){google.maps.event.addListener(marker,'mouseover',function(){close_info_window();info.open(map,marker);last_window=info;mousemove_timer=setTimeout(function(){$('.info-window .slide').css('left',0);setTimeout(function(){mousemove_timer=!1},300)},10)})})(marker,info_window,map_object);$(document).on('mousemove',function(e){if(!mousemove_timer&&(last_window||!1)){last_window.close&&last_window.close();last_window=null;mousemove_timer=!1}});$(document).on('mousemove','.info-window',function(e){e.stopPropagation()});$(window).on('resize',function(){centerMap()});centerMap();window.close_info_window=function(){if(last_window!==null){$('.info-window .slide').css('left',-200);setTimeout(function(){last_window.close();last_window=null},300)}}})(jQuery);(function($){var tri_carousel_owl=$('.tri-carousel.owl-carousel');tri_carousel_owl.owlCarousel({dots:!1,center:!0,autoWidth:!1,loop:!0,mouseDrag:!0,pullDrag:!0,freeDrag:!1,autoplay:!0,autoplayHoverPause:!0,responsiveClass:!0,responsive:{0:{margin:15,stagePadding:40,items:1,},928:{margin:40,items:3,},1800:{margin:40,items:3,},2150:{margin:40,}}});tri_carousel_owl.on('changed.owl.carousel',function(e){tri_carousel_owl.trigger('stop.owl.autoplay');tri_carousel_owl.trigger('play.owl.autoplay')});$('section.tri-carousel .pagination .page-left').click(function(){tri_carousel_owl.trigger('prev.owl.carousel')});$('section.tri-carousel .pagination .page-right').click(function(){tri_carousel_owl.trigger('next.owl.carousel')})})(jQuery);(function($){var consultation_owl=$('.half.with-icons:not(.three-icons):not(.four-icons) .consultation.owl-carousel');consultation_owl.owlCarousel({margin:0,loop:!1,dots:!1,autoWidth:!1,autoplay:!1,autoplayHoverPause:!0,responsiveClass:!0,responsive:{0:{items:1,margin:40,slideBy:1,mouseDrag:!0,touchDrag:!0,loop:!0,nav:!0,navText:[],},1260:{items:6,margin:0,slideBy:6,mouseDrag:!1,touchDrag:!1,loop:!1,nav:!1,navText:[],}}});var three_icons_owl=$('.half.with-icons.three-icons .consultation.owl-carousel');three_icons_owl.owlCarousel({margin:0,loop:!1,dots:!1,autoWidth:!1,autoplay:!1,autoplayHoverPause:!0,responsiveClass:!0,responsive:{0:{items:1,slideBy:1,mouseDrag:!0,touchDrag:!0,loop:!0,nav:!0,navText:[],},1260:{items:3,slideBy:3,mouseDrag:!1,touchDrag:!1,loop:!1,nav:!1,navText:[],}}});var four_icons_owl=$('.half.with-icons.four-icons .consultation.owl-carousel');four_icons_owl.owlCarousel({margin:0,loop:!1,dots:!1,autoWidth:!1,autoplay:!1,autoplayHoverPause:!0,responsiveClass:!0,responsive:{0:{items:1,slideBy:1,mouseDrag:!0,touchDrag:!0,loop:!0,nav:!0,navText:[],},1260:{items:4,slideBy:4,mouseDrag:!1,touchDrag:!1,loop:!1,nav:!1,navText:[],}}})})(jQuery);(function($){let carousel='section.overlap.carousel',device=$(window).width()>782?'desktop':'mobile',owl=$(carousel).find('.owl-carousel'),interval_desktop=null;function resetInterval(){if(interval_desktop)clearInterval(interval_desktop);interval_desktop=setInterval(function(){$(carousel).find('.pagination-container .pagination .page-right').trigger('click')},4000)}
