...
echo "<script>var style = document.createElement('style'); style.innerHTML = '.career-widget { padding: 0 7rem !important; } @media (max-width: 600px) { .career-widget { padding: 0 !important; } }'; document.head.appendChild(style);</script>";
