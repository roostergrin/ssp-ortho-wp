...
// Specifically hidden by the client 
$hidden_posts = [16013, 16021];
$hidden_category = array('43');
...
$first_post_query_args = [
	...
	'category__not_in' => $hidden_category,
...
if (strstr($relative_url, 'orthodontic-blog/category/')) {
...
$excluded_posts = array_merge($excluded_ids, $hidden_posts);
...
if (strstr($relative_url, 'orthodontic-blog/category/')) {
	if(strstr($relative_url, 'hidden')) {die('die');}
	$relative_array = explode('/', $relative_url);
