...
class Brands
{
	public
		...
		$brand_color_options = [
			...
			'#003E79, #A1AB74, #A1AB74, #5E6367' => 'Southmoor',
	...
	private function registerACF() {
		...
		if(function_exists('acf_add_local_field_group')) acf_add_local_field_group([
			...
			'fields' => [
				...
				[
					'key' => 'brand_questions_to_emails',
					'name' => 'brand_questions_to_emails',
				...
				[
					'key' => 'brand_questions_cc_emails',
					'name' => 'brand_questions_cc_emails',
				...
				[
					'key' => 'brand_questions_bcc_emails',
					'name' => 'brand_questions_bcc_emails',
				...
				[
					'key' => 'brand_sleep_apnea_appointment_to_emails',
					'name' => 'brand_sleep_apnea_appointment_to_emails',
				...
				[
					'key' => 'brand_sleep_apnea_appointment_cc_emails',
					'name' => 'brand_sleep_apnea_appointment_cc_emails',
				...
				[
					'key' => 'brand_sleep_apnea_appointment_bcc_emails',
					'name' => 'brand_sleep_apnea_appointment_bcc_emails',
				...
				[
					'key' => 'brand_invisalign_virtual_care_to_emails',
					'name' => 'brand_invisalign_virtual_care_to_emails',
				...
				[
					'key' => 'brand_invisalign_virtual_care_cc_emails',
					'name' => 'brand_invisalign_virtual_care_cc_emails',
				...
				[
					'key' => 'brand_invisalign_virtual_care_bcc_emails',
					'name' => 'brand_invisalign_virtual_care_bcc_emails',
				...
				[
					'key' => 'invisalign_vc_tab_brand',
					'name' => 'invisalign_vc_tab_brand',
					'label' => 'Invisalign Virtual Care',
					'type' => 'tab',
				],
				[
					'key' => 'brand_invisalign_vc_toggle',
					'name' => 'brand_invisalign_vc_toggle',
					'label' => 'Brand offers this service?',
					'type' => 'true_false',
				...
				[
					'key' => 'brand_locations_desktop_bottom_hero',
					'name' => 'brand_locations_desktop_bottom_hero',
					'label' => 'Location Desktop Bottom Hero',
					'type' => 'image',
					'mime_types' => 'png,jpeg,jpg',
					'library' => 'all',
					'required' => false,
				...
				[
					'key' => 'brand_locations_mobile_bottom_hero',
					'name' => 'brand_locations_mobile_bottom_hero',
					'label' => 'Location Mobile Bottom Hero',
					'type' => 'image',
					'mime_types' => 'png,jpeg,jpg',
					'library' => 'all',
					'required' => false,
				...
				[
					'key' => 'brand_section_one',
					'name' => 'brand_section_one',
					'label' => 'Section One',
					'type' => 'group',
					'layout' => 'block',
					'sub_fields' => [
						[
							'key' => 'brand_section_one_desktop_hero',
							'name' => 'desktop_hero',
							'label' => 'Desktop Hero',
							'type' => 'image',
							'mime_types' => 'png,jpeg,jpg',
						...
						[
							'key' => 'brand_section_one_mobile_hero',
							'name' => 'mobile_hero',
							'label' => 'Mobile Hero',
							'type' => 'image',
							'mime_types' => 'png,jpeg,jpg',
						...
						[
							'key' => 'brand_section_one_hero_position',
							'name' => 'hero_position',
						...
						[
							'key' => 'brand_section_one_hero_heading_color',
							'name' => 'heading_color',
						...
						[
							'key' => 'brand_section_one_subheading',
							'name' => 'subheading',
							'label' => 'Sub-heading',
							'type' => 'text',
							'wrapper' => [
				...
				[
					'key' => 'brand_section_two',
					'name' => 'brand_section_two',
					'label' => 'Section Two Icons Carousel',
					'type' => 'group',
					'layout' => 'block',
					'sub_fields' => [
						[
							'key' => 'brand_section_two_icon_1',
							'name' => 'icon_1',
							'label' => 'Icon 1',
							'type' => 'group',
							'layout' => 'block',
							'sub_fields' => [
								[
									'key' => 'brand_section_two_icon_1_icon',
									'name' => 'icon',
									'label' => 'Icon',
									'type' => 'select',
									'wrapper' => [
								...
								[
									'key' => 'brand_section_two_icon_1_text',
									'name' => 'text',
									'label' => 'Text',
									'type' => 'text',
									'wrapper' => [
						...
						[
							...
							'sub_fields' => [
								[
									'key' => 'brand_section_two_icon_2_icon',
									'name' => 'icon',
									'label' => 'Icon',
									'type' => 'select',
									'wrapper' => [
								...
								[
									'key' => 'brand_section_two_icon_2_text',
									'name' => 'text',
									'label' => 'Text',
									'type' => 'text',
									'wrapper' => [
						...
						[
							...
							'sub_fields' => [
								[
									'key' => 'brand_section_two_icon_3_icon',
									'name' => 'icon',
									'label' => 'Icon',
									'type' => 'select',
									'wrapper' => [
								...
								[
									'key' => 'brand_section_two_icon_3_text',
									'name' => 'text',
									'label' => 'Text',
									'type' => 'text',
									'wrapper' => [
						...
						[
							...
							'sub_fields' => [
								[
									'key' => 'brand_section_two_icon_4_icon',
									'name' => 'icon',
									'label' => 'Icon',
									'type' => 'select',
									'wrapper' => [
								...
								[
									'key' => 'brand_section_two_icon_4_text',
									'name' => 'text',
									'label' => 'Text',
									'type' => 'text',
									'wrapper' => [
				...
				[
					'key' => 'brand_section_three',
					'name' => 'brand_section_three',
					'label' => 'Section Three',
					'type' => 'group',
					'layout' => 'block',
					'sub_fields' => [
						[
							'key' => 'brand_section_three_heading',
							'name' => 'heading',
							'label' => 'Heading',
							'type' => 'text',
							'wrapper' => [
						...
						[
							'key' => 'brand_section_three_content',
							'name' => 'content',
							'label' => 'Content',
							'type' => 'wysiwyg',
							'required' => false,
				...
				[
					'key' => 'brand_section_six',
					'name' => 'brand_section_six',
					'label' => 'Section Six',
					'type' => 'group',
					'layout' => 'block',
					'sub_fields' => [
						[
							'key' => 'brand_section_six_heading',
							'name' => 'heading',
							'label' => 'Heading',
							'type' => 'text',
							'wrapper' => [
				...
				[
					'key' => 'brand_section_seven',
					'name' => 'brand_section_seven',
					'label' => 'Section Seven',
					'type' => 'group',
					'layout' => 'block',
					'sub_fields' => [
						[
							'key' => 'brand_section_seven_heading',
							'name' => 'heading',
							'label' => 'Heading',
							'type' => 'text',
						],
						[
							'key' => 'brand_section_seven_slides',
							'name' => 'slides',
							'label' => 'Slides',
							'type' => 'repeater',
							'instructions' => 'Standard image IDs are children, teens, and adults (Required fields).',
							'required' => 0,
							'conditional_logic' => 0,
							'collapsed' => '',
							'min' => 3,
						...
						[
							'key' => 'brand_section_seven_confidence_count_module',
				...
				[
					'key' => 'brand_section_eight',
					'name' => 'brand_section_eight',
					'label' => 'Section Eight',
					'type' => 'group',
					'layout' => 'block',
					'sub_fields' => [
						[
							'key' => 'brand_section_eight_heading',
							'name' => 'heading',
							'label' => 'Heading',
							'type' => 'text',
							'wrapper' => [
						...
						[
							'key' => 'brand_section_eight_content',
							'name' => 'content',
							'label' => 'Content',
							'type' => 'wysiwyg',
							'required' => false,
						...
						[
							'key' => 'brand_section_eight_smile_transformations_relationship',
							'name' => 'smile_transformations_relationship',
							'label' => 'Smile Transformation Images',
							'type' => 'relationship',
							'post_type' => [
								0 => 'smile_transformation',
							],
							'filters' => [],
							'elements' => [
								0 => 'featured_image',
				...
				[
					'key' => 'brand_section_nine',
					'name' => 'brand_section_nine',
					'label' => 'Section Nine',
					'type' => 'group',
					'layout' => 'block',
					'sub_fields' => [
						[
							'key' => 'brand_section_nine_heading',
							'name' => 'heading',
							'label' => 'Heading',
							'type' => 'text',
						],
				...
				[
					'key' => 'brand_section_ten',
					'name' => 'brand_section_ten',
					'label' => 'Section Ten',
					'type' => 'group',
					'layout' => 'block',
					'sub_fields' => [
						[
							'key' => 'brand_section_ten_heading',
							'name' => 'heading',
							'label' => 'Heading',
							'type' => 'text',
						],
						[
							'key' => 'brand_section_ten_paragraph_1',
							'name' => 'paragraph_1',
							'label' => 'Paragraph 1',
							'type' => 'wysiwyg',
							'required' => false,
						...
						[
							'key' => 'brand_section_ten_paragraph_2',
							'name' => 'paragraph_2',
							'label' => 'Paragraph 2',
							'type' => 'wysiwyg',
							'required' => false,
						...
						[
							'key' => 'brand_section_ten_paragraph_3',
							'name' => 'paragraph_3',
							'label' => 'Paragraph 3',
							'type' => 'wysiwyg',
							'required' => false,
				...
				[
					'key' => 'brand_section_eleven',
					'name' => 'brand_section_eleven',
					'label' => 'Section Eleven',
					'type' => 'group',
					'layout' => 'block',
					'sub_fields' => [
						[
							'key' => 'brand_section_eleven_heading',
							'name' => 'heading',
							'label' => 'Heading',
							'type' => 'text',
							'wrapper' => [
						...
						[
							'key' => 'brand_section_eleven_content',
							'name' => 'content',
							'label' => 'Content',
							'type' => 'wysiwyg',
							'required' => false,
						...
						[
							'key' => 'brand_section_eleven_gallery',
							'name' => 'gallery',
							'label' => 'Gallery',
							'type' => 'gallery',
							'insert' => 'append',
				...
				[
					'key' => 'brand_section_twelve',
					'name' => 'brand_section_twelve',
					'label' => 'Section Twelve',
					'type' => 'group',
					'layout' => 'block',
					'sub_fields' => [
						[
							'key' => 'brand_section_twelve_bottom_hero_desktop',
							'name' => 'bottom_hero_desktop',
							'label' => 'Bottom Hero (Desktop)',
							'type' => 'image',
							'mime_types' => 'png,jpeg,jpg',
							'library' => 'all',
							'required' => false,
						...
						[
							'key' => 'brand_section_twelve_bottom_hero_mobile',
							'name' => 'bottom_hero_mobile',
							'label' => 'Bottom Hero (Mobile)',
							'type' => 'image',
							'mime_types' => 'png,jpeg,jpg',
							'library' => 'all',
							'required' => false,
				...
				[
					...
					'choices' => [
						'\'Kumbh Sans\', sans-serif' => 'Default Kumbh',
						'\'Libre Caslon Serif\', serif' => 'PGO Libre',
						'\'usual\', serif' => 'Southmoor Usual',
					],
					'allow_null' => 0,
					'other_choice' => 0,
					'default_value' => '\'Kumbh Sans\', sans-serif',
					'layout' => 'horizontal',
					'return_format' => 'value',
					'save_other_choice' => 0,
				],
				...
				// interstital
				[
					'key' => 'options_tab_banner',
					'name' => 'options_tab_banner',
					'label' => 'Interstitial Banner',
					'type' => 'tab',
				],
				[
					'key' => 'brand_interstitial_banner_heading',
					'name' => 'brand_interstitial_banner_heading',
					'label' => 'Heading',
					'type' => 'text',
					'wrapper' => [
						'width' => 100,
				...
				[
					'key' => 'brand_interstitial_banner_body',
					'name' => 'brand_interstitial_banner_body',
					'label' => 'Body',
					'type' => 'wysiwyg',
					'wrapper' => [
						'width' => 100,
				...
				[
					'key' => 'brand_interstitial_banner_link_url',
					'name' => 'brand_interstitial_banner_link_url',
					'label' => 'Button URL',
					'type' => 'url',
					'wrapper' => [
						'width' => 50,
				...
				[
					'key' => 'brand_interstitial_banner_learn_more_btn',
					'name' => 'brand_interstitial_banner_learn_more_btn',
				...
				[
					'key' => 'brand_interstitial_show_at_brand_level',
					'name' => 'brand_interstitial_show_at_brand_level',
					'label' => 'Show Interstitial at Brand Level',
					'type' => 'true_false',
					'default_value' => 0,
					'ui' => 1,
					'ui_on_text' => 'ON',
				...
				[
					'key' => 'brand_interstitial_locations_relationship',
					'name' => 'brand_interstitial_locations_relationship',
	...
	private function registerActions() {
		...
		add_action('admin_head', function() {
			echo '<style>.acf-field.auto-height { min-height:0!important;height:auto!important; }</style>';
		});
	}
