...
// All in One SEO Pack
add_filter('aioseo_prev_link', function() { return false; });
add_filter('aioseo_next_link', function() { return false; });
//add_filter('aioseop_home_page_title', function($text) { return do_shortcode($text); });
add_filter('aioseo_title', function($text) { return do_shortcode($text); });
...
add_filter('aioseo_description', function($text) { return do_shortcode($text); });
// add_filter('aioseo_description_attributes', function($text) { return do_shortcode($text); });
...
add_filter('aioseo_keywords', function($text) { return strtolower(do_shortcode(strtoupper($text))); });
...
add_filter('aioseo_facebook_tags', function($facebookMeta) { 
	$facebookMeta['og:site_name'] = do_shortcode('[BRAND_TITLE]'); 
	return $facebookMeta;
});
