...
//=====================================[SHARED]=====================================//
	...
	function get_all_views() {
		return ['contact', 'questions', 'consultation', 'appointment', 'refer', 'community', 'orthodontic-referral', 'review', 'custom-mouthguard', 'invisalign-virtual-care', 'pediatric-contact', 'pediatric-appointment', 'pediatric-community', 'pediatric-orthodontic-referral', 'events'];
	}
