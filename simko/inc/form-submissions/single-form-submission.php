...
if (!in_array($form, get_all_views())) {
	...
	if (count($submissions)) {
        ...
        // Shows Office name instead of Id.
		$general_metadata->office_preference = get_the_title($general_metadata->office_preference);
			...
			<div class="module_wrapper">
				...
				<section>
					...
					<?php foreach($submission_details as $label => $value): ?>
						<div>
						<?php if($submission_details['Form Name'] == 'event' && $label == 'event_select'): ?>
							<span class="label">Registered Event</span> <span class="value"><?php echo get_event_name_by_id(stripslashes($value)) ?></span>
						<?php else: ?>						
